...
#print(d.center(5))     # Center the string within a specified width
...
g = "Hello\\World!"  # \\ is a backslash character
h = "Hello\"World!"  # \" is a double quote character
i = "Hello\'World!"  # \' is a single quote character
